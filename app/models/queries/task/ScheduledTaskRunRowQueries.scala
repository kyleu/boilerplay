...
object ScheduledTaskRunRowQueries extends BaseQueries[ScheduledTaskRunRow]("scheduledTaskRunRow", "scheduled_task_run") {
  ...
  override def fromRow(row: Row) = ScheduledTaskRunRow(
    id = UuidType(row, "id"),
