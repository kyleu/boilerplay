...
class StaffRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[StaffRow]("staffRow", "store" -> "StaffRow") {
  def getByPrimaryKey(creds: Credentials, staffId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def getByPrimaryKeySeq(creds: Credentials, staffIdSeq: Seq[Int])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByAddressId(creds: Credentials, addressId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.addressId")(td => db.queryF(StaffRowQueries.CountByAddressId(addressId))(td))
  }
  def getByAddressId(creds: Credentials, addressId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.addressId")(td => db.queryF(StaffRowQueries.GetByAddressId(addressId, orderBys, limit, offset))(td))
  }
  ...
  def countByEmail(creds: Credentials, email: String)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.email")(td => db.queryF(StaffRowQueries.CountByEmail(email))(td))
  }
  def getByEmail(creds: Credentials, email: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.email")(td => db.queryF(StaffRowQueries.GetByEmail(email, orderBys, limit, offset))(td))
  }
  ...
  def countByFirstName(creds: Credentials, firstName: String)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.firstName")(td => db.queryF(StaffRowQueries.CountByFirstName(firstName))(td))
  }
  def getByFirstName(creds: Credentials, firstName: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.firstName")(td => db.queryF(StaffRowQueries.GetByFirstName(firstName, orderBys, limit, offset))(td))
  }
  ...
  def countByLastName(creds: Credentials, lastName: String)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.lastName")(td => db.queryF(StaffRowQueries.CountByLastName(lastName))(td))
  }
  def getByLastName(creds: Credentials, lastName: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.lastName")(td => db.queryF(StaffRowQueries.GetByLastName(lastName, orderBys, limit, offset))(td))
  }
  ...
  def countByStaffId(creds: Credentials, staffId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.staffId")(td => db.queryF(StaffRowQueries.CountByStaffId(staffId))(td))
  }
  def getByStaffId(creds: Credentials, staffId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.staffId")(td => db.queryF(StaffRowQueries.GetByStaffId(staffId, orderBys, limit, offset))(td))
  }
  ...
  def countByStoreId(creds: Credentials, storeId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.storeId")(td => db.queryF(StaffRowQueries.CountByStoreId(storeId))(td))
  }
  def getByStoreId(creds: Credentials, storeId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.storeId")(td => db.queryF(StaffRowQueries.GetByStoreId(storeId, orderBys, limit, offset))(td))
  }
  ...
  def countByUsername(creds: Credentials, username: String)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.username")(td => db.queryF(StaffRowQueries.CountByUsername(username))(td))
  }
  def getByUsername(creds: Credentials, username: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.username")(td => db.queryF(StaffRowQueries.GetByUsername(username, orderBys, limit, offset))(td))
  }
  def getByUsernameSeq(creds: Credentials, usernameSeq: Seq[String])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def remove(creds: Credentials, staffId: Int)(implicit trace: TraceData) = checkPerm(creds, "edit") {
  ...
  def update(creds: Credentials, staffId: Int, fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
