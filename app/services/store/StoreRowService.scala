...
class StoreRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[StoreRow]("storeRow", "store" -> "StoreRow") {
  def getByPrimaryKey(creds: Credentials, storeId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def getByPrimaryKeySeq(creds: Credentials, storeIdSeq: Seq[Int])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByAddressId(creds: Credentials, addressId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.addressId")(td => db.queryF(StoreRowQueries.CountByAddressId(addressId))(td))
  }
  def getByAddressId(creds: Credentials, addressId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.addressId")(td => db.queryF(StoreRowQueries.GetByAddressId(addressId, orderBys, limit, offset))(td))
  }
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.lastUpdate")(td => db.queryF(StoreRowQueries.CountByLastUpdate(lastUpdate))(td))
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.lastUpdate")(td => db.queryF(StoreRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td))
  }
  ...
  def countByManagerStaffId(creds: Credentials, managerStaffId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.managerStaffId")(td => db.queryF(StoreRowQueries.CountByManagerStaffId(managerStaffId))(td))
  }
  def getByManagerStaffId(creds: Credentials, managerStaffId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.managerStaffId")(td => db.queryF(StoreRowQueries.GetByManagerStaffId(managerStaffId, orderBys, limit, offset))(td))
  }
  def getByManagerStaffIdSeq(creds: Credentials, managerStaffIdSeq: Seq[Int])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByStoreId(creds: Credentials, storeId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.storeId")(td => db.queryF(StoreRowQueries.CountByStoreId(storeId))(td))
  }
  def getByStoreId(creds: Credentials, storeId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.storeId")(td => db.queryF(StoreRowQueries.GetByStoreId(storeId, orderBys, limit, offset))(td))
  }
  ...
  // Mutations
  def insert(creds: Credentials, model: StoreRow)(implicit trace: TraceData) = checkPerm(creds, "edit") {
    traceF("insert")(td => db.executeF(StoreRowQueries.insert(model))(td).flatMap {
      case 1 => getByPrimaryKey(creds, model.storeId)(td)
      case _ => throw new IllegalStateException("Unable to find newly-inserted Store")
    })
  }
  def insertBatch(creds: Credentials, models: Seq[StoreRow])(implicit trace: TraceData) = checkPerm(creds, "edit") {
    traceF("insertBatch")(td => if (models.isEmpty) {
      Future.successful(0)
    } else {
      db.executeF(StoreRowQueries.insertBatch(models))(td)
    })
  }
  def create(creds: Credentials, fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
    traceF("create")(td => db.executeF(StoreRowQueries.create(fields))(td).flatMap { _ =>
      getByPrimaryKey(creds, fieldVal(fields, "storeId").toInt)
    })
  }

  def remove(creds: Credentials, storeId: Int)(implicit trace: TraceData) = checkPerm(creds, "edit") {
  ...
  def update(creds: Credentials, storeId: Int, fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
  ...
  def updateBulk(creds: Credentials, pks: Seq[Seq[Any]], fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
    db.executeF(StoreRowQueries.updateBulk(pks, fields))(trace).map { x =>
