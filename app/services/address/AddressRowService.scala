...
class AddressRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[AddressRow]("addressRow") {
  def getByPrimaryKey(creds: Credentials, addressId: Int)(implicit trace: TraceData) = {
  ...
  def getByPrimaryKeySeq(creds: Credentials, addressIdSeq: Seq[Int])(implicit trace: TraceData) = if (addressIdSeq.isEmpty) {
  ...
  def countByAddress(creds: Credentials, address: String)(implicit trace: TraceData) = traceF("count.by.address") { td =>
    db.queryF(AddressRowQueries.CountByAddress(address))(td)
  }
  def getByAddress(creds: Credentials, address: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.address") { td =>
    db.queryF(AddressRowQueries.GetByAddress(address, orderBys, limit, offset))(td)
  }
  def getByAddressSeq(creds: Credentials, addressSeq: Seq[String])(implicit trace: TraceData) = if (addressSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByAddress2(creds: Credentials, address2: String)(implicit trace: TraceData) = traceF("count.by.address2") { td =>
    db.queryF(AddressRowQueries.CountByAddress2(address2))(td)
  }
  def getByAddress2(creds: Credentials, address2: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.address2") { td =>
    db.queryF(AddressRowQueries.GetByAddress2(address2, orderBys, limit, offset))(td)
  }
  def getByAddress2Seq(creds: Credentials, address2Seq: Seq[String])(implicit trace: TraceData) = if (address2Seq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByAddressId(creds: Credentials, addressId: Int)(implicit trace: TraceData) = traceF("count.by.addressId") { td =>
    db.queryF(AddressRowQueries.CountByAddressId(addressId))(td)
  }
  def getByAddressId(creds: Credentials, addressId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.addressId") { td =>
    db.queryF(AddressRowQueries.GetByAddressId(addressId, orderBys, limit, offset))(td)
  }
  ...
  def countByCityId(creds: Credentials, cityId: Int)(implicit trace: TraceData) = traceF("count.by.cityId") { td =>
    db.queryF(AddressRowQueries.CountByCityId(cityId))(td)
  }
  def getByCityId(creds: Credentials, cityId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.cityId") { td =>
    db.queryF(AddressRowQueries.GetByCityId(cityId, orderBys, limit, offset))(td)
  }
  ...
  def countByDistrict(creds: Credentials, district: String)(implicit trace: TraceData) = traceF("count.by.district") { td =>
    db.queryF(AddressRowQueries.CountByDistrict(district))(td)
  }
  def getByDistrict(creds: Credentials, district: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.district") { td =>
    db.queryF(AddressRowQueries.GetByDistrict(district, orderBys, limit, offset))(td)
  }
  def getByDistrictSeq(creds: Credentials, districtSeq: Seq[String])(implicit trace: TraceData) = if (districtSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = traceF("count.by.lastUpdate") { td =>
    db.queryF(AddressRowQueries.CountByLastUpdate(lastUpdate))(td)
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.lastUpdate") { td =>
    db.queryF(AddressRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td)
  }
  ...
  def countByPhone(creds: Credentials, phone: String)(implicit trace: TraceData) = traceF("count.by.phone") { td =>
    db.queryF(AddressRowQueries.CountByPhone(phone))(td)
  }
  def getByPhone(creds: Credentials, phone: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.phone") { td =>
    db.queryF(AddressRowQueries.GetByPhone(phone, orderBys, limit, offset))(td)
  }
  def getByPhoneSeq(creds: Credentials, phoneSeq: Seq[String])(implicit trace: TraceData) = if (phoneSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByPostalCode(creds: Credentials, postalCode: String)(implicit trace: TraceData) = traceF("count.by.postalCode") { td =>
    db.queryF(AddressRowQueries.CountByPostalCode(postalCode))(td)
  }
  def getByPostalCode(creds: Credentials, postalCode: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.postalCode") { td =>
    db.queryF(AddressRowQueries.GetByPostalCode(postalCode, orderBys, limit, offset))(td)
  }
  def getByPostalCodeSeq(creds: Credentials, postalCodeSeq: Seq[String])(implicit trace: TraceData) = if (postalCodeSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  // Mutations
  def insert(creds: Credentials, model: AddressRow)(implicit trace: TraceData) = traceF("insert") { td =>
    db.executeF(AddressRowQueries.insert(model))(td).flatMap {
  ...
  def insertBatch(creds: Credentials, models: Seq[AddressRow])(implicit trace: TraceData) = {
  ...
  def create(creds: Credentials, fields: Seq[DataField])(implicit trace: TraceData) = traceF("create") { td =>
    db.executeF(AddressRowQueries.create(fields))(td).flatMap { _ =>
      getByPrimaryKey(creds, fieldVal(fields, "addressId").toInt)
    }
  }

  def remove(creds: Credentials, addressId: Int)(implicit trace: TraceData) = {
  ...
  def update(creds: Credentials, addressId: Int, fields: Seq[DataField])(implicit trace: TraceData) = {
