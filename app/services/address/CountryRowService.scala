...
class CountryRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[CountryRow]("countryRow", "address" -> "CountryRow") {
  def getByPrimaryKey(creds: Credentials, countryId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def getByPrimaryKeySeq(creds: Credentials, countryIdSeq: Seq[Int])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByCountry(creds: Credentials, country: String)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.country")(td => db.queryF(CountryRowQueries.CountByCountry(country))(td))
  }
  def getByCountry(creds: Credentials, country: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.country")(td => db.queryF(CountryRowQueries.GetByCountry(country, orderBys, limit, offset))(td))
  }
  def getByCountrySeq(creds: Credentials, countrySeq: Seq[String])(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByCountryId(creds: Credentials, countryId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.countryId")(td => db.queryF(CountryRowQueries.CountByCountryId(countryId))(td))
  }
  def getByCountryId(creds: Credentials, countryId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.countryId")(td => db.queryF(CountryRowQueries.GetByCountryId(countryId, orderBys, limit, offset))(td))
  }
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.lastUpdate")(td => db.queryF(CountryRowQueries.CountByLastUpdate(lastUpdate))(td))
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.lastUpdate")(td => db.queryF(CountryRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td))
  }
  ...
  def remove(creds: Credentials, countryId: Int)(implicit trace: TraceData) = checkPerm(creds, "edit") {
  ...
  def update(creds: Credentials, countryId: Int, fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
