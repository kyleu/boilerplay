...
class FilmRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[FilmRow]("filmRow") {
  def getByPrimaryKey(creds: Credentials, filmId: Int)(implicit trace: TraceData) = {
  ...
  def getByPrimaryKeySeq(creds: Credentials, filmIdSeq: Seq[Int])(implicit trace: TraceData) = if (filmIdSeq.isEmpty) {
  ...
  def countByFilmId(creds: Credentials, filmId: Int)(implicit trace: TraceData) = traceF("count.by.filmId") { td =>
    db.queryF(FilmRowQueries.CountByFilmId(filmId))(td)
  }
  def getByFilmId(creds: Credentials, filmId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.filmId") { td =>
    db.queryF(FilmRowQueries.GetByFilmId(filmId, orderBys, limit, offset))(td)
  }
  ...
  def countByLanguageId(creds: Credentials, languageId: Int)(implicit trace: TraceData) = traceF("count.by.languageId") { td =>
    db.queryF(FilmRowQueries.CountByLanguageId(languageId))(td)
  }
  def getByLanguageId(creds: Credentials, languageId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.languageId") { td =>
    db.queryF(FilmRowQueries.GetByLanguageId(languageId, orderBys, limit, offset))(td)
  }
  def getByLanguageIdSeq(creds: Credentials, languageIdSeq: Seq[Int])(implicit trace: TraceData) = if (languageIdSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = traceF("count.by.lastUpdate") { td =>
    db.queryF(FilmRowQueries.CountByLastUpdate(lastUpdate))(td)
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.lastUpdate") { td =>
    db.queryF(FilmRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td)
  }
  ...
  def countByOriginalLanguageId(creds: Credentials, originalLanguageId: Int)(implicit trace: TraceData) = traceF("count.by.originalLanguageId") { td =>
    db.queryF(FilmRowQueries.CountByOriginalLanguageId(originalLanguageId))(td)
  }
  def getByOriginalLanguageId(creds: Credentials, originalLanguageId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.originalLanguageId") { td =>
    db.queryF(FilmRowQueries.GetByOriginalLanguageId(originalLanguageId, orderBys, limit, offset))(td)
  }
  def getByOriginalLanguageIdSeq(creds: Credentials, originalLanguageIdSeq: Seq[Int])(implicit trace: TraceData) = if (originalLanguageIdSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByRating(creds: Credentials, rating: MpaaRatingType)(implicit trace: TraceData) = traceF("count.by.rating") { td =>
    db.queryF(FilmRowQueries.CountByRating(rating))(td)
  }
  def getByRating(creds: Credentials, rating: MpaaRatingType, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.rating") { td =>
    db.queryF(FilmRowQueries.GetByRating(rating, orderBys, limit, offset))(td)
  }
  def getByRatingSeq(creds: Credentials, ratingSeq: Seq[MpaaRatingType])(implicit trace: TraceData) = if (ratingSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  def countByTitle(creds: Credentials, title: String)(implicit trace: TraceData) = traceF("count.by.title") { td =>
    db.queryF(FilmRowQueries.CountByTitle(title))(td)
  }
  def getByTitle(creds: Credentials, title: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.title") { td =>
    db.queryF(FilmRowQueries.GetByTitle(title, orderBys, limit, offset))(td)
  }
  def getByTitleSeq(creds: Credentials, titleSeq: Seq[String])(implicit trace: TraceData) = if (titleSeq.isEmpty) {
    Future.successful(Nil)
  } else {
  ...
  // Mutations
  def insert(creds: Credentials, model: FilmRow)(implicit trace: TraceData) = traceF("insert") { td =>
    db.executeF(FilmRowQueries.insert(model))(td).flatMap {
      case 1 => getByPrimaryKey(creds, model.filmId)(td)
      case _ => throw new IllegalStateException("Unable to find newly-inserted Film.")
    }
  }
  def insertBatch(creds: Credentials, models: Seq[FilmRow])(implicit trace: TraceData) = {
  ...
  def create(creds: Credentials, fields: Seq[DataField])(implicit trace: TraceData) = traceF("create") { td =>
    db.executeF(FilmRowQueries.create(fields))(td).flatMap { _ =>
      getByPrimaryKey(creds, fieldVal(fields, "filmId").toInt)
    }
  }

  def remove(creds: Credentials, filmId: Int)(implicit trace: TraceData) = {
  ...
  def update(creds: Credentials, filmId: Int, fields: Seq[DataField])(implicit trace: TraceData) = {
