...
class ActorRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[ActorRow]("actorRow") {
  def getByPrimaryKey(creds: Credentials, actorId: Int)(implicit trace: TraceData) = {
  ...
  def getByPrimaryKeySeq(creds: Credentials, actorIdSeq: Seq[Int])(implicit trace: TraceData) = if (actorIdSeq.isEmpty) {
  ...
  def countByActorId(creds: Credentials, actorId: Int)(implicit trace: TraceData) = traceF("count.by.actorId") { td =>
    db.queryF(ActorRowQueries.CountByActorId(actorId))(td)
  }
  def getByActorId(creds: Credentials, actorId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.actorId") { td =>
    db.queryF(ActorRowQueries.GetByActorId(actorId, orderBys, limit, offset))(td)
  }
  ...
  def countByFirstName(creds: Credentials, firstName: String)(implicit trace: TraceData) = traceF("count.by.firstName") { td =>
    db.queryF(ActorRowQueries.CountByFirstName(firstName))(td)
  }
  def getByFirstName(creds: Credentials, firstName: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.firstName") { td =>
    db.queryF(ActorRowQueries.GetByFirstName(firstName, orderBys, limit, offset))(td)
  }
  ...
  def countByLastName(creds: Credentials, lastName: String)(implicit trace: TraceData) = traceF("count.by.lastName") { td =>
    db.queryF(ActorRowQueries.CountByLastName(lastName))(td)
  }
  def getByLastName(creds: Credentials, lastName: String, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.lastName") { td =>
    db.queryF(ActorRowQueries.GetByLastName(lastName, orderBys, limit, offset))(td)
  }
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = traceF("count.by.lastUpdate") { td =>
    db.queryF(ActorRowQueries.CountByLastUpdate(lastUpdate))(td)
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.lastUpdate") { td =>
    db.queryF(ActorRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td)
  }
  ...
  // Mutations
  def insert(creds: Credentials, model: ActorRow)(implicit trace: TraceData) = traceF("insert") { td =>
    db.executeF(ActorRowQueries.insert(model))(td).flatMap {
      case 1 => getByPrimaryKey(creds, model.actorId)(td)
      case _ => throw new IllegalStateException("Unable to find newly-inserted Actor.")
    }
  }
  def insertBatch(creds: Credentials, models: Seq[ActorRow])(implicit trace: TraceData) = {
  ...
  def create(creds: Credentials, fields: Seq[DataField])(implicit trace: TraceData) = traceF("create") { td =>
    db.executeF(ActorRowQueries.create(fields))(td).flatMap { _ =>
      getByPrimaryKey(creds, fieldVal(fields, "actorId").toInt)
    }
  }

  def remove(creds: Credentials, actorId: Int)(implicit trace: TraceData) = {
  ...
  def update(creds: Credentials, actorId: Int, fields: Seq[DataField])(implicit trace: TraceData) = {
