...
class FilmCategoryRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[FilmCategoryRow]("filmCategoryRow") {
  def getByPrimaryKey(creds: Credentials, filmId: Int, categoryId: Int)(implicit trace: TraceData) = {
  ...
  def countByCategoryId(creds: Credentials, categoryId: Int)(implicit trace: TraceData) = traceF("count.by.categoryId") { td =>
    db.queryF(FilmCategoryRowQueries.CountByCategoryId(categoryId))(td)
  }
  def getByCategoryId(creds: Credentials, categoryId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.categoryId") { td =>
    db.queryF(FilmCategoryRowQueries.GetByCategoryId(categoryId, orderBys, limit, offset))(td)
  }
  ...
  def countByFilmId(creds: Credentials, filmId: Int)(implicit trace: TraceData) = traceF("count.by.filmId") { td =>
    db.queryF(FilmCategoryRowQueries.CountByFilmId(filmId))(td)
  }
  def getByFilmId(creds: Credentials, filmId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.filmId") { td =>
    db.queryF(FilmCategoryRowQueries.GetByFilmId(filmId, orderBys, limit, offset))(td)
  }
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = traceF("count.by.lastUpdate") { td =>
    db.queryF(FilmCategoryRowQueries.CountByLastUpdate(lastUpdate))(td)
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = traceF("get.by.lastUpdate") { td =>
    db.queryF(FilmCategoryRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td)
  }
  ...
  // Mutations
  def insert(creds: Credentials, model: FilmCategoryRow)(implicit trace: TraceData) = traceF("insert") { td =>
    db.executeF(FilmCategoryRowQueries.insert(model))(td).flatMap {
  ...
  def insertBatch(creds: Credentials, models: Seq[FilmCategoryRow])(implicit trace: TraceData) = {
    traceF("insertBatch")(td => db.executeF(FilmCategoryRowQueries.insertBatch(models))(td))
  }
  def create(creds: Credentials, fields: Seq[DataField])(implicit trace: TraceData) = traceF("create") { td =>
    db.executeF(FilmCategoryRowQueries.create(fields))(td).flatMap { _ =>
      getByPrimaryKey(creds, fieldVal(fields, "filmId").toInt, fieldVal(fields, "categoryId").toInt)
    }
  }

  def remove(creds: Credentials, filmId: Int, categoryId: Int)(implicit trace: TraceData) = {
  ...
  def update(creds: Credentials, filmId: Int, categoryId: Int, fields: Seq[DataField])(implicit trace: TraceData) = {
