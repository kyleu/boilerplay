...
class FilmActorRowService @javax.inject.Inject() (val db: JdbcDatabase, override val tracing: TracingService)(implicit ec: ExecutionContext) extends ModelServiceHelper[FilmActorRow]("filmActorRow", "film" -> "FilmActorRow") {
  def getByPrimaryKey(creds: Credentials, actorId: Int, filmId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
  ...
  def countByActorId(creds: Credentials, actorId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.actorId")(td => db.queryF(FilmActorRowQueries.CountByActorId(actorId))(td))
  }
  def getByActorId(creds: Credentials, actorId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.actorId")(td => db.queryF(FilmActorRowQueries.GetByActorId(actorId, orderBys, limit, offset))(td))
  }
  ...
  def countByFilmId(creds: Credentials, filmId: Int)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.filmId")(td => db.queryF(FilmActorRowQueries.CountByFilmId(filmId))(td))
  }
  def getByFilmId(creds: Credentials, filmId: Int, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.filmId")(td => db.queryF(FilmActorRowQueries.GetByFilmId(filmId, orderBys, limit, offset))(td))
  }
  ...
  def countByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("count.by.lastUpdate")(td => db.queryF(FilmActorRowQueries.CountByLastUpdate(lastUpdate))(td))
  }
  def getByLastUpdate(creds: Credentials, lastUpdate: ZonedDateTime, orderBys: Seq[OrderBy] = Nil, limit: Option[Int] = None, offset: Option[Int] = None)(implicit trace: TraceData) = checkPerm(creds, "view") {
    traceF("get.by.lastUpdate")(td => db.queryF(FilmActorRowQueries.GetByLastUpdate(lastUpdate, orderBys, limit, offset))(td))
  }
  ...
  def remove(creds: Credentials, actorId: Int, filmId: Int)(implicit trace: TraceData) = checkPerm(creds, "edit") {
  ...
  def update(creds: Credentials, actorId: Int, filmId: Int, fields: Seq[DataField])(implicit trace: TraceData) = checkPerm(creds, "edit") {
